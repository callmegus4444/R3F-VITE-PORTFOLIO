...
const AboutSection = (props) => {
  ...
  return (
    <Section mobileTop>
      ...
      <div className="flex flex-col md:flex-row gap-4 mt-4 md:mt-16">
        <motion.button
      ...
      rounded-lg font-bold text-lg`}
        ...
        <motion.a
          href="https://drive.google.com/file/d/1ArcuGa32psK-Xv71o7xubpHNY1cOg-hE/view?usp=drive_link"
          target="_blank"
          rel="noopener noreferrer"
          className={`bg-purple-500 hover:bg-pink-700 dark:bg-space-500 dark:hover:bg-space-600 text-white py-4 px-8 transition-colors shadow-[0_0_15px_rgba(190,24,93,0.5)] dark:shadow-[0_0_15px_rgba(147,51,234,0.5)] hover:shadow-[0_0_25px_rgba(190,24,93,0.8)] dark:hover:shadow-[0_0_25px_rgba(147,51,234,0.8)]
      rounded-lg font-bold text-lg text-center flex items-center justify-center`}
          initial={{
            opacity: 0,
            y: 25,
          }}
  ...
  return (
    <Section>
      ...
      <div className="w-full md:w-auto md:absolute md:right-8 md:bottom-32 flex flex-row md:flex-col items-center justify-center gap-8 z-50 mt-10 md:mt-0">
        ...
        <a href="mailto:cutek5547@gmail.com" className="text-black dark:text-gray-400 hover:text-space-500 dark:hover:text-space-400 transition-colors transform hover:scale-110 pointer-events-auto">
          <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
